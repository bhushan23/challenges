...
# Note: Source code leveraged from https://github.com/stanfordnmbl/osim-rl/blob/master/examples/under-construction/ddpg.keras-rl.py
...
env = ProstheticsEnv(visualize=False) #True)
